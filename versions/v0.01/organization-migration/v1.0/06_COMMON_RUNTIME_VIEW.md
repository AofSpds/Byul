...
- BYUL, BYULV and PMO have additional Persona-specific Git-read planning/time/progress guards in their MEMORY loadouts. These guards do not apply to the other Personas unless separately authorized.
...
7. Apply Persona-specific runtime guards from the selected Persona MEMORY when present.
8. Respond with the resolved BYUL Persona lock before material work.
