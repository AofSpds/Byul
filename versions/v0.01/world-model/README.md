# BYUL World Model Research Artifacts

STATE = RESEARCH_WORKING / NON_NORMATIVE / NOT_VALIDATED / NOT_FROZEN

This directory preserves current Owner-facing BYUL World Model design snapshots and research roadmaps without creating ontology freeze, validation PASS, production authorization, or AAA mutation.

## Current companion artifacts — 2026-08-26

1. `BYUL_WORLD_MODEL_CURRENT_DESIGN_STATUS_2026-08-26_v1.1.md`
   - consolidated current design snapshot;
   - Relation / Composition / V-C-T / Routing / FOLD / Orientation / Causality / Primitive-admission / performance-flexibility track;
